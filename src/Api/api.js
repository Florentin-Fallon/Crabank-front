const BASE_URL = "https://de23-195-7-117-146.ngrok-free.app"; // Replace with the actual base URL of the API
...
async function addAccountBeneficiary(bban, beneficiaryId) {
    return await apiRequest("POST", `/account/${bban}/beneficiaries`, beneficiaryId);
}
