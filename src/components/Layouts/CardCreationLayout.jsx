...
import {Alert, Box, Fab, MenuItem, Select, Snackbar, TextField, Typography} from "@mui/material";
import AddIcon from '@mui/icons-material/Add';
import PreviewCard from "../../Assets/PreviewCard.svg";
import {createAccount, createAccountCard, getAccountFirstCard, getCurrentAccount} from "../../Api/api";
...
function CardCreationLayout({account, setValue}) {
    ...
    const handleCardCreation = async () => {
        ...
        let toSend = { 'name': cardName, 'network': cardNetwork, 'type': cardType, 'style': cardStyle };
        try {
        ...
        <Box>
            ...
            <Box>
                <Box sx={{display: "flex", flexDirection: "column", justifyContent: "center", gap: 2}}>
                    ...
                    >
                        <MenuItem value={'debit'}>Carte de débit (retrait instantané)</MenuItem>
                        <MenuItem value={'credit'}>Carte de crédit (retrait différé)</MenuItem>
                    </Select>
                    <Select
                        value={cardStyle}
                        variant="outlined"
                    ...
                    >
                        <MenuItem value={'black'}>Edition spéciale Club du Crousti-Crabe</MenuItem>
                    </Select>
